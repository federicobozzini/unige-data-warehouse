-- AdventureWorksDB for PostgresQL
--  modified by Giovanna Guerrini for the Data Warehousing course 2016-17

-- Extract the .zip and copy all of the CSV files into the same folder containing
-- this AdventureworksDB.sql script


-- Create the database and tables, import the data and set keys with:
--   psql -c "CREATE DATABASE \"Adventureworks\";"
--   psql -d Adventureworks < AdventureworksDB.sql
-- [psql -U studente if using PostgreSQL in the container]
